...
class Atri:
	...
	def Container(self, new_state):
		...
		global default_state
		self._Container = Flex(new_state, default_state["Container"])
	...
	def Logo(self, new_state):
		...
		global default_state
		self._Logo = Div(new_state, default_state["Logo"])
